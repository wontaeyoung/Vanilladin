...
<img width="500" src="https://github.com/wontaeyoung/Vanilladin/assets/45925685/d83a22f0-a58c-4f54-9a48-cdf0d10644aa">

단일 책임과 기능을 가진 클래스를 사용할 때, 필요한 시점에 인스턴스를 휘발적으로 생성해서 사용하거나 싱글톤으로 단일 인스턴스를 메모리에 올려두고 사용할 수 있습니다.

두 방법 모두 함수를 호출하는데 있어서 큰 차이가 없었기 때문에, 결정을 위한 다른 기준이 고민되었습니다.
